    ...
    <div className="bg">
      ...
      <main className="relative">
        <div className="flex bg-green-200">
          ...
          <div className="w-2/6 mobile-top-right right-div">
            <p className="p-3 m-1 p-header justify-around mobile-top-p">ホーム</p>
            <p className="p-3 m-1 p-header justify-around mobile-top-p"><a href="https://github.com/aranpect">開発物</a></p>
            <p className="p-3 m-1 p-header justify-around mobile-top-p">お問い合わせ</p>
          </div>
        </div>
        <section>
          <div className="flex">
